...
/**
 * Interface representing the output of a paged user search.
 */
export interface SearchUserPagedOutput {
  /**
  ...
  /**
   * Date of the last payment made by the client, if applicable.
   */
