...
import { MENSAGEM_ALTERACAO_STATUS_SUCESSO, MENSAGEM_ALTERACAO_SUCESSO, MENSAGEM_INCLUSAO_SUCESSO, MENSAGEM_LISTA_VAZIA, MENSAGEM_PERGUNTA, MENSAGEM_REGISTRO_SALVO_COM_SUCESSO } from '../constant/messages';
...
export function emitirMensagemAlertaCommon(messageService: MessageService, message: any) {
